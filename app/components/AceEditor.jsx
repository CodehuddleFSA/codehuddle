...
export default class ReactAce extends PureComponent {
  ...
  handleMarkers(markers) {
    ...
    markers.forEach((rangeObj) => {
      const range = new Range(rangeObj.start.row, rangeObj.start.column, rangeObj.end.row, rangeObj.end.column);
      this.editor.getSession().addMarker(range, 'error-marker', 'background', false);
    });
  }
